...
4. Manually ID all SRE bat passes (Myotis species, Plecotus species, Barbastelles) *AND 2000 NoIDs from each plot type* and subset the rest of the data to include at least one file per taxon per site and per night (method found in this study: https://www.nature.com/articles/s41598-021-89660-z) 

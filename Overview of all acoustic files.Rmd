...
## Approach 4 subsetting 
(previous approaches in found in version control)

4. Manually ID all SRE bat passes (Myotis species, Plecotus species, Barbastelles) *AND 2500 NoIDs from each plot type* and subset the rest of the data to include at least one file per taxon per site and per night (method found in this study: https://www.nature.com/articles/s41598-021-89660-z) 
...
alt2.5 <- alt2 %>% dplyr::filter(autoid != "NoID") 
...
alt4 <- full_join(alt2.5, sub_NoID)
dim(alt4) # 103874 
...
# # Copy files that match the file paths into a new folder. 
# file.copy(from = MYOALC.filepaths,
#            to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOALC/WAV")
#  beep() # that worked! 
...
# 
# # # Copy files that match the file paths into a new folder. 
# file.copy(from = MYOBEC.filepaths,
#            to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBEC/WAV")
#  beep() # that worked! 
...
# 
# # # Copy files that match the file paths into a new folder. 
# file.copy(from = MYOBRA.filepaths,
#            to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV")
#  beep() # that worked! 
...
# This is more manageable 
 ...
 ## Need to break this into multiple subdirectories. 
 
 # 25764/12 = 2147 files
 # Create 5 sub-directories within MYOBRA with 4039 files per folder 
#  
# for (i in 1:5) {
#     newdir <- paste0("P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV",i)
#     dir.create(newdir) } # that worked!
#  
#  ## Copy 2147 files from the WAV folder into each sub directory 
 
MYOBRA_wav<-  list.files("P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV",)
beep()

MYOBRA_df <- as.data.frame(MYOBRA_wav)

 ################################################################################

MYOBRA1 <- MYOBRA_df[1:4039,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV/", MYOBRA1),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV1")
beep()

################################################################################

MYOBRA2 <- MYOBRA_df[4040:8078,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV/", MYOBRA2),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV2")
beep()

################################################################################

MYOBRA3 <- MYOBRA_df[8079:12117,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV/", MYOBRA3),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV3")
beep()
 
################################################################################

MYOBRA4 <- MYOBRA_df[12118:16156,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV/", MYOBRA4),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV4")
beep()
 

################################################################################

MYOBRA5 <- MYOBRA_df[12118:20195,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV/", MYOBRA5),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOBRA/WAV5")
beep()
...
# # # Copy files that match the file paths into a new folder. 
# file.copy(from = MYODAS.filepaths,
#            to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAS/WAV")
#  beep() # that worked! 
#  
#   ## Remove MKT bats 
...
# # Copy files that match the file paths into a new folder. 
file.copy(from = MYODAU.filepaths,
           to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV")
 beep() # that worked! 
...
################################################################################
 ...
 # 25764/12 = 2147 files
 # Create 12 sub-directories within MYODAU with 2147 files per folder 
 
# for (i in 1:12) {
#     newdir <- paste0("P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV",i)
#     dir.create(newdir) } # that worked!
 
 ## Copy 2147 files from the WAV folder into each sub directory 
 
myodau_wav<-  list.files("P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV",)
beep()

myodau_df <- as.data.frame(myodau_wav)

myodau1 <- myodau_df[1:2147,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau1),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV1")
beep()


myodau2 <- myodau_df[2148:4294,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau2),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV2")
beep()

myodau3 <- myodau_df[4295:6441,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau3),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV3")
beep()

myodau4 <- myodau_df[6442:8588,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau4),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV4")
beep()

myodau5 <- myodau_df[8589:10735,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau5),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV5")
beep()


myodau6 <- myodau_df[10736:12882,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau6),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV6")
beep()

myodau7 <- myodau_df[12883:15029,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau7),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV7")
beep()

myodau8 <- myodau_df[15030:17176,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau8),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV8")
beep()

myodau9 <- myodau_df[17177:19323,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau9),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV9")
beep()

myodau10 <- myodau_df[19324:21470,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau10),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV10")
beep()

myodau11 <- myodau_df[21471:23617,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau11),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV11")
beep()

myodau12 <- myodau_df[23618:25764,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV/", myodau12),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYODAU/WAV12")
beep()
...
# # Copy files that match the file paths into a new folder. 
file.copy(from = MYOMYO.filepaths,
           to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYO/WAV")
 beep() # that worked! 
...
# # Copy files that match the file paths into a new folder. 
file.copy(from = MYOMYS.filepaths,
           to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV")
 beep() # 
...
# This is more manageable 
 ...
 # Create 5 sub-directories within MYOBRA with 4178 (ish) files per folder 
 
# for (i in 1:4) {
#     newdir <- paste0("P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV",i)
#     dir.create(newdir) } # that worked!
 
 ## Copy 2147 files from the WAV folder into each sub directory 
 
MYOMYS_wav<-  list.files("P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV",)
beep()

MYOMYS_df <- as.data.frame(MYOMYS_wav)

 ################################################################################

MYOMYS1 <- MYOMYS_df[1:4178,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV/", MYOMYS1),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV1")
beep()

 ################################################################################

MYOMYS2 <- MYOMYS_df[4178:8356,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV/", MYOMYS2),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV2")
beep()

 ################################################################################

MYOMYS3 <- MYOMYS_df[8357:12534,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV/", MYOMYS3),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV3")
beep()

################################################################################

MYOMYS4 <- MYOMYS_df[12535:16714,]

file.copy(from = paste0(
  "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV/", MYOMYS4),
           to = 
            "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYOMYS/WAV4")
beep()
...
sub_MYOMYS1 <- sub_MYOMYS[1:5658,]
sub_MYOMYS2 <- sub_MYOMYS[5658:11317,]
...
# # Copy files that match the file paths into a new folder. 
file.copy(from = MYONAT.filepaths,
           to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/MYONAT/WAV")
 beep() # that worked! 
...
mkt_MYONAT <- mkt %>% dplyr::filter(AUTO.ID == "MYONAT") %>% 
  distinct(filename) %>% dplyr::select(filename) # 2487 obs of 1 col 
sub_MYONAT <- anti_join(MYONAT, mkt_MYONAT) # 4135
...
# # Copy files that match the file paths into a new folder. 
file.copy(from = PLEAUR.filepaths,
           to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/PLEAUR/WAV")
 beep() # that worked! 
...
mkt_PLEAUR <- mkt %>% dplyr::filter(AUTO.ID == "PLEAUR") %>% 
  distinct(filename) %>% dplyr::select(filename) # 2487 obs of 1 col 
sub_PLEAUR <- anti_join(PLEAUR, mkt_PLEAUR) # 4135
...
# # Copy files that match the file paths into a new folder. 
file.copy(from = PLEAUS.filepaths,
           to = "P:/FolloForest2021/FolloForest_ManualAcousticAnalysis/PLEAUS/WAV")
 beep() # that worked! 
...
mkt_PLEAUS <- mkt %>% dplyr::filter(AUTO.ID == "PLEAUS") %>% 
  distinct(filename) %>% dplyr::select(filename) # 2487 obs of 1 col 
sub_PLEAUS <- anti_join(PLEAUS, mkt_PLEAUS) # 4135
...
### Non target subset (from alt4) 

```{r}
summary(alt4)

alt4.1 <- alt4 %>% dplyr::filter(autoid %in% c(EPTNIL, EPTSER, PIPPIP, PIPNAT, PIPPYG, NYCLEI, NYCNOC, VESMUR)) %>% droplevels() %>% mutate(filename = OUT.FILE.FS) 

dim(alt4.1)

FF3 <- FF1 %>% dplr::select(filename, fullfilepath) 
...
################################################################################
 ...
 # EPTNIL
EPTNIL <- alt4.1 %>% dplyr::filter(autoid == "EPTNIL") #1928 batpasses 

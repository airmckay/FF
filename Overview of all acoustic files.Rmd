...
FF2 <- FF1 %>% filter(autoid %in% c("BARBAR", "MYOALC", "MYOBEC",
                     ...
                     "PLEAUS", "PLEAUR")) %>% droplevels()
# BARBAR
BABA <- FF2 %>% dplyr::filter(autoid == "BARBAR") #2337 bat passes 
BABA.filepaths <- BABA$fullfilepath
...
################################################################################
 ### Start here 
 # MYOMYS
MYOMYS <- FF2 %>% dplyr::filter(autoid == "MYOMYS") #240 batpasses 
...
################################################################################
 ...
 # MYONAT
MYONAT <- FF2 %>% dplyr::filter(autoid == "MYONAT") #240 batpasses 
...
################################################################################
 ...
 # PLEAUR
PLEAUR <- FF2 %>% dplyr::filter(autoid == "PLEAUR") #240 batpasses 
...
################################################################################
 ...
 # PLEAUS
PLEAUS <- FF2 %>% dplyr::filter(autoid == "PLEAUS") #240 batpasses 
